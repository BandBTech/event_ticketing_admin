...
const AdminDashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadData() {
      const res = await getPendingOrganizers();
      const res2 = await getPendingEvents();
      setPendingData(res);
      setPendingEventsData(res2);
    }
    loadData();
  }, []);
  ...
  const organizers = pendingData?.data?.organizers || [];
  const pendingEvents = pendingEventsData?.data?.organizers || [];
                ...
                <div className="h-64 flex items-center justify-center">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-gray-400">
                      When organizers submit events for review, they&apos;ll
                      appear here
                    </p>
                  </div>
                </div>
