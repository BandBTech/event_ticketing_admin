...
// //   const totalTicketsSold = event.tiers.reduce(
// //     (sum, ticket) => sum + Math.floor(ticket.quantity * 0.4),
// //     0
// //   );
...
// //     (sum, ticket) => sum + Math.floor(ticket.quantity * 0.4) * ticket.price,
// //     0
// //   );
//   return (
//     <>
...
//                     <div
//                       key={ticket.id}
//                       className={`space-y-2 p-3 rounded-lg shadow-sm ${color.cardClass}`}
//                     >
//                       <div className="flex justify-between text-sm">
//                         <p className={`font-semibold ${color.labelClass}`}>
//                           {ticket.tier_name}
//                         </p>
//                         <p className="text-gray-600">
//                           NPR {ticket.price}/ticket
//                         </p>
//                       </div>
...
//                           style={{
//                             width: `${(sold / ticket.quantity) * 100}%`,
//                           }}
//                         />
//                       </div>
//                       <span className="text-sm">
//                         {sold}/{ticket.quantity} sold
//                       </span>
//                     </div>
//                   );
//                 })} */}
