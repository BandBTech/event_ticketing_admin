        ...
        {displayItems.map((item) => {
          ...
          return (
            <div key={historyItem.id} className="relative pl-10 group">
              <div className="absolute left-0 top-1 w-8 h-8 flex items-center justify-center rounded-full bg-gray-50 border border-gray-100 group-first:border-emerald-500 z-10 transition-colors">
